        ...
        <>
            <section className="grid grid-cols-1 lg:grid-cols-2 w-11/12 lg:w-10/12 mx-auto my-5 gap-4">
                <div className="mx-auto order-2 lg:order-last flex items-center justify-center">
                    <div className="size-[60%] lg:size-[80%] flex items-center justify-center">
                ...
                <div className="order-1 lg:order-1 flex flex-col justify-center lg:gap-2">
                    <h1 className="font-semibold text-2xl text-center lg:text-start md:text-3xl lg:text-4xl lg:font-bold text-[#FF725E] mt-5 mb-3">Kontribusi <span className="text-[#2F327D] ">Penelitian</span></h1>
                    <div className="mx-auto flex flex-col items-center lg:justify-start lg:gap-5 lg:text-lg">
                        <p className="text-muted-foreground text-center lg:text-start md:text-lg lg:text-xl font-medium">
                        ...
                        <Button variant="primaryPink" className="mt-5 lg:self-start" asChild >
                            <Link href={"/documents/penelitian"}>Lebih lanjut...</Link>
                        </Button>
                    </div>
                </div>
            </section>
