...
const EducationSection = () => {
    return (
        <>
            <section className="grid grid-cols-1 lg:grid-cols-2 w-11/12 lg:w-10/12 mx-auto my-5 gap-4">
                <div className="mx-auto order-2 lg:order-1 flex items-center justify-center">
                    <div className="size-[65%] lg:size-[85%] flex items-center justify-center">
                ...
                <div className="order-1 lg:order-last flex flex-col justify-center lg:gap-2">
                    <h1 className="font-semibold text-2xl text-center md:text-3xl lg:text-4xl lg:font-bold text-[#2F327D] mt-5 mb-3">Pendidikan <span className="text-[#F48C06] ">Dr.Dedy Hartama, S.T, M.Kom</span></h1>
                    <div className="mx-auto flex flex-col items-center lg:justify-start lg:text-lg">
                        <p className="text-muted-foreground text-center  md:text-lg lg:text-xl font-medium">Dr. Dedy Hartama menyelesaikan pendidikan formalnya di beberapa universitas terkemuka:</p>
                        ...
                        <Button variant="primaryYellow" className="mt-5" asChild >
