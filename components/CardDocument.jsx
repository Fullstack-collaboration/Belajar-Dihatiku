...
const CardDocument = ({ link, title, description, logo, color }) => {
    return (
      <Link href={link} className=" hover:scale-105 hover:shadow-cyan-100 hover:lg:shadow-cyan-300 cursor-pointer transition  rounded-lg border-2 shadow-xl border-slate-100 px-5 py-8 text-center w-11/12 lg:w-[30%] relative flex flex-col gap-3">
        <div
